...
<div class="row">
    ...
    <form action="script.php" method="POST" id="formulaire_contact" enctype="multipart/form-data">
      <fieldset>
      <legend>
    ...
    <fieldset>
      ...
      <div class="form-group form-check">
        <input type="checkbox" class="form-check-input" id="checkBut" name="checkBut">
        <label class="form-check-label" for="disabledFieldsetCheck" id="checkBut" >J'accepte le traitement de ce formulaire
        </label>
    </div><br>
